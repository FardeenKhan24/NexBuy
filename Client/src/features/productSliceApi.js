...
const initialState = {
  ...
  priceFilter: "default",
  searchQuery: "",
  likedProducts: JSON.parse(localStorage.getItem("likedProducts"))?.filter(id => id !== null) || [],
  loading: false,
  error: null,
};
...
export const { setFilter, setPriceFilter, setSearchQuery, applyFilter, toggleLike } = productSlice.actions;
